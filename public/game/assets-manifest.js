// Generated asset paths (kept in one place so the build can rewrite extensions if needed).
export const AUDIO = {
  music: "./assets/audio/music_cozy.m4a",
  pinch: "./assets/audio/sfx_pinch.mp3",
